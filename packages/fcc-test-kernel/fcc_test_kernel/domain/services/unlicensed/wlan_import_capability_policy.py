...
from fcc_test_kernel.domain.models.capability_taxonomy import DtsSubFamily, SubFamily, UniiSubFamily
from fcc_test_kernel.domain.models.enums import FIVE_GHZ_BANDS, SIX_GHZ_BANDS, BandType
from fcc_test_kernel.domain.services.unlicensed.wlan_report_partition import WLAN_2_4GHZ_BAND
