...
Domain types live in :mod:`fcc_test_kernel.domain.models.log_event` — this module imports
...
from fcc_test_kernel.domain.models.log_event import LogEntry, extract_topic
from fcc_test_kernel.domain.ports.output.log_event_port import LogEventPort
from fcc_test_kernel.infrastructure.logging.json_formatter import (
