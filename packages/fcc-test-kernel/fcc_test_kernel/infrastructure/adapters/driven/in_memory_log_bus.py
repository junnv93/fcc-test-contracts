...
from fcc_test_kernel.domain.models.log_event import LOGGER_PREFIX, LogEntry
from fcc_test_kernel.domain.ports.output.log_event_port import (
    LogEventCallback,
    LogEventPort,
    Subscription,
)
...
# is the SSOT from ``fcc_test_kernel.domain.models.log_event`` — no string literal here.
