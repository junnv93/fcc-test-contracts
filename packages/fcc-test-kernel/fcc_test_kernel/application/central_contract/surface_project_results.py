...
from fcc_test_kernel.application.central_contract.api_operation_factory import _CLAIM_CONFLICT_409, _operation
from fcc_test_kernel.application.central_contract.api_vocabulary import PLATFORM_NEXT_CURSOR_HEADER
