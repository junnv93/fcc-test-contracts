# fcc_test_kernel.logger_config.py
...
from fcc_test_kernel.infrastructure.logging.log_handler import InMemoryLogHandler
from fcc_test_kernel.infrastructure.logging.json_formatter import StructuredJsonFormatter
from fcc_test_kernel.infrastructure.logging.session_log_custody import (
...
from fcc_test_kernel.domain.ports.output.log_event_port import LogEventPort
from fcc_test_kernel.domain.ports.output.notification_event_port import NotificationEventPort
...
class LoggingSystem:
    ...
    def _setup(self) -> None:
        ...
        from fcc_test_kernel.infrastructure.adapters.driven.in_memory_log_bus import (
            InMemoryLogBus,
        )
        ...
        from fcc_test_kernel.infrastructure.adapters.driven.in_memory_notification_bus import (
        ...
        # :mod:`fcc_test_kernel.infrastructure.logging.session_log_custody` 가 소유한다. 그 형식이 곧
...
#: :mod:`fcc_test_kernel.infrastructure.logging.session_log_custody` 가 **둘 다 위임**한다. 봉인이 비공개
...
def _cleanup_old_logs(
    ...
    *,
    ...
    1. **보관 락** (:func:`~fcc_test_kernel.infrastructure.logging.session_log_custody.is_session_directory_claimed`)
...
def __getattr__(name: str):
    ...
    raise AttributeError(f"module 'fcc_test_kernel.logger_config' has no attribute {name!r}")
